...
import {
  department,
  gender,
} from "../../containers/private/sys_admin/constants/department";
          ...
          <div className="w-2/3 bg-white my-10 border-[1px] border-[#ddd]">
            <div className="border-b-[1px] bg-[#f4f5f7]">
              <div className="flex justify-between items-center py-3 px-10">
                <h1 className="font-Oswald text-[20px] uppercase">
                  Staff Registration
                </h1>
                <div className="flex justify-center items-center space-x-2 cursor-pointer">
                  <div className="w-7 h-7 flex justify-center items-center cursor-pointer hover:rounded-full hover:bg-[#ddd]">
                    <Bi.BiMinus />
                  </div>
                  <div className="w-7 h-7 flex justify-center items-center cursor-pointer hover:rounded-full hover:bg-[#ddd]">
                    <Vsc.VscChromeRestore />
                  </div>
                  <div
                    className="w-7 h-7 flex justify-center items-center cursor-pointer hover:rounded-full hover:bg-[#ddd]"
            ...
            <div className="flex justify-between items-center px-10 py-5">
              ...
              <div className="w-1/2 flex flex-col">
                <h1 className="font-Oswald text-[25px] uppercase">
                  User Registration Form
                </h1>
                <p className="font-Poppins text-xs text-[#5c727d]">
                  Mixed Investment Group LTD.
                </p>
                <p className="font-Poppins text-xs text-[#5c727d]">
                  project control management system(PCMS)
                </p>
              </div>
            ...
            <form onSubmit={(event) => event.preventDefault()}>
              <div className="mx-5 my-2 border-[2px] border-black">
                <div className="px-5 py-2 border-b-[2px] border-black flex justify-center">
                  <h1 className="font-Poppins text-[18px] text-black uppercase">
                    Employee Details
                  </h1>
                </div>
              ...
              <div className="mx-5 border-[2px] border-gray-400">
                <div className="bg-gray-500 px-5 py-2">
                  <h1 className="font-Poppins text-[18px] text-white uppercase text-center">
                    Account Information
                  </h1>
                </div>
                <div className="my-5">
