    ...
    return (
      <div className="relative peer">
        <div className="border-b-2 border-black -px-2 peer">
          ...
          <label className={`font-Poppins text-sm absolute -top-3.5 text-gray-500 transition-all peer-focus:text-sm ${selected ? "-top-5 left-0" : "top-2"} ${selected ? "peer-placeholder-shown:text-base peer-placeholder-shown:top-2" : "peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-3.5 left-6"}`}>
            Date of Birth
          </label>
          <DatePicker 
