...
import { csrf_token } from "../../../../services/features/auth/authSlice";
...
const ModalRegistrationForm = ({ modalTrigger, setModalTrigger }) => {
        ...
        <InnerContainer className="w-[40%] h-full  mx-auto bg-white my-10 border-[1px] border-[#ddd] px-1 text-sm">
          <div className="flex justify-between items-center">
            <div className={`flex flex-col py-10 px-5`}>
              <h1 className="font-bold text-[25px]">
                PCMS <span className="text-[#00bfdd]">ProV</span>
              </h1>
              <p className="text-[#c4c0c0] text-sm pl-5">
                mixed investment group plc
              </p>
            </div>

            <div className="flex flex-col font-semibold">
              <h1 className="flex items-center uppercase pr-5">
                project control management system
              </h1>
              <p className="ml-auto pr-5 block text-[#c4c0c0] ">
                User registration form
              </p>
              <div className="ml-auto pr-5 mt-4">
                <div
                  className="flex items-center bg-red-600 py-1 px-5 text-white cursor-pointer"
          ...
          >
            ...
            <div className="border-t-[2px] border-b-[2px] border-black bg-[#eee] py-2">
              <h1 className="text-[18px] px-5 uppercase">
            ...
            <div className="pt-5 flex space-x-5 justify-end">
              ...
              <Button
                label="Clear"
                className="px-5 bg-[#ddd] text-sm border-none rounded-none hover:bg-white hover:text-black hover:ring-2 hover:ring-green-900 w-[10%]"
