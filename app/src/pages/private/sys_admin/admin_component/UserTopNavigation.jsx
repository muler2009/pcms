...
import { ModalRegistrationForm } from "../admin_component";
...
const UserTopNavigation = () => {
      ...
      if (item.dropdown) {
        return (
          <div key={index} className="relative">
            <div
              className="flex items-center justify-between space-x-3 px-4 py-0 text-sm font-medium text-black cursor-pointer"
            ...
            <div
              className={`absolute z-50 mt-3.5 ml-4 px-0.5 py-1 bg-[#EEE] border-[2px] border-t-0 border-black ${
                drop[index] ? "block" : "hidden"
              }`}
            >
  ...
  return (
    <>
      <OuterContainer className="font-Poppins py-3 px-10 text-black flex justify-between items-center border-[2px] border-[#eee] mx-5 bg-white">
